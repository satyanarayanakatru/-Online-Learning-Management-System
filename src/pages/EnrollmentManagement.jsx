      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-18 px-4 sm:px-6 lg:px-8 teal-glass-panel border-b border-emerald-500/20 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-black text-white tracking-tight">Course Enrollment</h1>
              <p className="text-xs text-emerald-200/60 font-semibold hidden sm:block">Module 5: Student Course Registrations & Summary</p>
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 p-6 space-y-6 max-w-7xl mx-auto w-full">
          <div className="teal-glass-card p-8 rounded-3xl text-center space-y-4">
            ...
            <h3 className="text-2xl font-black text-white">Enrollment Management Module</h3>
            <p className="text-xs text-emerald-200/70 max-w-md mx-auto">
              Ready for Module 5: Enroll Student into Course, View Enrolled Courses, Remove Enrollment, Duplicate Checks & Details.
            </p>
          </div>
        </main>
      </div>
