...
// Local mock dataset for Course Management
const MOCK_COURSES = [
  {
    id: 'crs-1',
    ...
    level: 'Intermediate',
    price: 49.99,
    description: 'Learn modern React 19 Server Components, Context API, Hooks, and Next.js 15 App Router architecture from scratch.',
    rating: 4.9,
  ...
  },
  {
    ...
    level: 'Beginner',
    price: 39.99,
    description: 'Master utility-first CSS, custom design tokens, dark mode glassmorphism themes, and responsive UI components.',
    rating: 4.8,
  ...
  },
  {
    ...
    level: 'Advanced',
    price: 79.99,
    description: 'Build enterprise-grade REST APIs, JWT authentication middleware, Express, MongoDB, and Docker containerization.',
    rating: 4.9,
  ...
  },
  {
    ...
    level: 'Intermediate',
    price: 89.99,
    description: 'Comprehensive Python training for Pandas, NumPy, Scikit-Learn, Matplotlib, and predictive AI model building.',
    rating: 4.7,
  ...
  },
  {
    ...
    level: 'Beginner',
    price: 59.99,
    description: 'Hands-on network security, penetration testing, vulnerability assessment, cryptography, and defensive security.',
    rating: 4.8,
  ...
  },
  {
    ...
    level: 'Intermediate',
    price: 44.99,
    description: 'Build sleek native iOS and Android mobile applications using Google Flutter framework and State Management.',
    rating: 4.6,
    thumbnail: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&q=80'
  }
];

// Fetch courses from local mock data & LocalStorage
...
export const updateCourseService = (id, updatedFields, existingCourses) => {
  const updatedList = existingCourses.map((c) =>
    c.id === id ? { ...c, ...updatedFields, price: Number(updatedFields.price) } : c
  );
  saveCoursesToStorage(updatedList);
  return updatedList;
};
