...
export default function DeleteStudentConfirmModal({ isOpen, student, onClose, onConfirmDelete }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="teal-glass-panel w-full max-w-md rounded-3xl p-6 space-y-5 shadow-2xl relative border border-rose-500/30 text-center">
        ...
        <div className="space-y-1">
          <h3 className="text-xl font-black text-white">Delete Student Record?</h3>
          <p className="text-xs text-emerald-200/70 font-semibold">
            Are you sure you want to remove student <strong className="text-amber-300">"{student.fullName}"</strong>? This will remove their record from the LMS database.
          </p>
        </div>
